# -*- coding: utf-8 -*-
"""
Created on Thu May  9 08:27:01 2019
...
duration    = {0:1,2:1,4:3,6:6}
nb_of_devint= {0:3,2:16,4:4,6:2}
...
for n in range(1,N+1):        
    ...
    p_rand_coef1=np.ones(10)
    p_rand_coef3=np.ones(8)
    p_rand_coef5=np.ones(17)
    p_rand_coef7=np.ones(18)

    p_rand_coef1=np.concatenate(tuple([1-np.random.uniform(0,magnitude[0])]*duration[0] for i in range(nb_of_devint[0])))    
    ...
    p_coef_arr=np.concatenate((p_rand_coef0,p_rand_coef1,p_rand_coef2,p_rand_coef3,p_rand_coef4,p_rand_coef5,p_rand_coef6,p_rand_coef7))
...
writer = pd.ExcelWriter("paper_deviations_1.xlsx")
